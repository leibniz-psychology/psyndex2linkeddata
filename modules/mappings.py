...
# A list of affiliation names/string _parts_ that indicate that the string needs to be completely replaced in the ror api string because ror can't find them
affilation_org_substr_replacelist = (
    ("Psychologische Information und Dokumentation", "Leibniz Institute for Psychology"),
    ("Leibniz Institute for Psychology Information", "Leibniz Institute for Psychology"),
    ("Universität Tübingen", "University of Tübingen"),
    ("Knowledge Media Research Center", "University of Tübingen"),
    ("Universität Magdeburg", "Otto-von-Guericke-Universität Magdeburg"),
    ...
    ("Medizinische Universität Lübeck", "University of Lübeck"),
    ("Universität Linz", "Johannes Kepler University of Linz"),
    ("Fernuniversität Gesamthochschule Hagen", "FernUniversität in Hagen"),
    ("Psychiatriezentrum Münsingen", "Psychiatriezentrum Münsingen"),
    ("Psychiatry Center Münsingen", "Psychiatriezentrum Münsingen"),
    ...
    ("Fondazione IRCCUS Ca' Granda Ospedale Maggiore Policlinico", "Fondazione IRCCS Ca' Granda Ospedale Maggiore Policlinico"),
    ("Hochschule Lüneburg", "Leuphana University of Lüneburg"),
    ("Universität Mainz", "Johannes Gutenberg University Mainz"),
    ("Leibniz Institute for Knowledge Media", "Leibniz-Institut für Wissensmedien"),
    ("Kammer für Arbeiter und Angestellte für Wien", "Kammer für Arbeiter und Angestellte Wien"),
    ("Jacobs University Bremen", "Constructor University"),
    ("Universität Frankfurt", "Goethe University Frankfurt"),
    ("Universität Bochum", "Ruhr University Bochum"),
    ("Universität Oldenburg", "Carl von Ossietzky Universität Oldenburg"),
    ("University of Oldenburg", "Carl von Ossietzky Universität Oldenburg"),
    ("Technische Hochschule Delft", "Delft University of Technology"),
    ("Technische Hochschule Zürich", "ETH Zurich"),
    ("Universität Marburg", "Philipps University of Marburg"),
    ("Uniklinik Aachen", "Universitätsklinikum Aachen"),
    ("Universität Basel; Psychiatrische Klinik", "Universitäre Psychiatrische Kliniken Basel"),
    ("Psychiatrische Universitätsklinik Basel", "Universitäre Psychiatrische Kliniken Basel"),
    ("University of Pittsburgh School of Medicine", "University of Pittsburgh"),
    ("Psychiatrische Universitätsklinik Wien", "Medical University of Vienna"),
    ("Feinberg School of Medicine", "Northwestern University"),
    ("Universität Gießen", "University of Giessen"),
    ("Internationales Zentralinstitut für das Jugend- und Bildungsfernsehen", "Bayerischer Rundfunk"),
    ("Karolinska Institute", "Karolinska Institute"),
    ("Personalstammamt der Bundeswehr", "Bundeswehr"),
    ("Humboldt-Universität Berlin", "Humboldt-Universität zu Berlin"),
    ("Fachhochschule Nürnberg", "Georg Simon Ohm University of Applied Sciences Nuremberg"),
    ("University of Heidelberg", "Heidelberg University"),
    ("Central Institute of Mental Health", "Central Institute of Mental Health"),
    ("Saarland University", "Saarland University"),
    ("Universität Saarbrücken", "Saarland University"),
    ("Katholische Universität Eichstätt", "Katholische Universität Eichstätt-Ingolstadt"),
    ("Gesamthochschule Wuppertal", "University of Wuppertal"),
    ("Städtisches Krankenhaus Görlitz", "Klinikum Görlitz"),
    ("Deutsches Krankenhausinstitut", "Deutsches Krankenhaus Institut"),
    ("Universität Halle-Wittenberg", "Martin Luther University Halle-Wittenberg"),
    ("Zentrum für Psychiatrie Weissenau", "Zentrum für Psychiatrie Südwürttemberg"),
    ("Technische Universität Dresden", "TU Dresden"),
    ("Fachhochschule Aargau", "FHNW University of Applied Sciences and Arts"),
    ("Fachhochschule Fulda", "Fulda University of Applied Sciences"),
    ("Universität Bonn", "University of Bonn"),
    ("Universitätskrankenhaus Eppendorf", "University Medical Center Hamburg-Eppendorf"),
    ("Gesamthochschule Siegen", "University of Siegen"),
    ("Fachhochschule Wiesbaden", "Hochschule RheinMain"),
    ...
    ("Büro Oliva", "Oliva (Switzerland)"),
    ("Verband Deutscher Rentenversicherungsträger","Deutsche Rentenversicherung Bund"),
    ("Kantonale Psychiatrische Klinik Münsterlingen" ,"Kantonsspital Münsterlingen"),
    ("Katholische Fachhochschule Paderborn", "Catholic University of Applied Sciences of North Rhine – Westphalia"),
    ("Technische Universität Braunschweig", "Technische Universität Braunschweig"),
    ("Niedersächsisches Landeskrankenhaus Tiefenbrunn", "Asklepios Fachklinikum Tiefenbrunn"),
    ("Universität Essen", "University of Duisburg-Essen"),
    ("Gesamthochschule Essen", "University of Duisburg-Essen"),
    ("St. George's Hospital Medical School", "St George's University of London"),
    ...
    ("Alice-Salomon-Fachhochschule", "Alice-Salomon-Hochschule Berlin"),
...
cm_mapping_lookup = [
    ...
    # things that get a "nonempirical" replacement cm and genre ScholarlyWork:
    {
        ...
        "new_cm": "20000",
        "new_cm_label": "nonempirical work",
        "new_genre": "ScholarlyWork",
        "sh": "",
        "ct": "",
    },
    ...
    # things that get a custom/specific replacement cm and genre ScholarlyWork:
    {
        ...
        "new_cm_label": "methodological study",
        "new_cm": "20010",
        "new_genre": "ScholarlyWork",
        "sh": "",
        "ct": "",
    },
    {
        ...
        "new_cm": "20020",
        "new_cm_label": "experience report",
        "new_genre": "ScholarlyWork",
        "sh": "",
        "ct": "",
    },
    {
        ...
        "new_cm_label": "intervention method description",
        "new_cm": "20030",
        "new_genre": "ScholarlyWork",
        "sh": "",
        "ct": "",
    },
    {
        ...
        "new_cm_label": "assessment method description",
        "new_cm": "20040",
        "new_genre": "ScholarlyWork",
        "sh": "",
        "ct": "",
    ...
    # things keeping their cm, but getting genre ResearchPaper:
    {
        ...
        "new_cm_label": "experimental study",
        # "new_cm": "10110",
        "new_cm": "10110",
        "new_genre": "ResearchPaper",
        "sh": "",
    ...
    },
    {
        ...
        "new_cm_label": "longitudinal empirical study",
        "new_cm": "10120",
        "new_genre": "ResearchPaper",
        "sh": "",
        "ct": "",
    },
    {
        ...
        "new_cm_label": "qualitative empirical study",
        "new_cm": "10130",
        "new_genre": "ResearchPaper",
        "sh": "",
        "ct": "",
    ...
    # things that become genre ResearchPaper and also move to a new, specific cm:
    {
        ...
        "new_cm_label": "randomized controlled trial",
        "new_cm": "10111",
        "new_genre": "ResearchPaper",
        "sh": "",
        "ct": "",
    ...
    },
    {
        ...
        "new_cm_label": "systematic review",
        "new_cm": "10150",
        "new_genre": "ResearchPaper",
        "sh": "",
        "ct": "",
    },
    {
        ...
        "new_cm_label": "clinical case report",
        "new_cm": "10160",
        "new_genre": "ResearchPaper",
        "sh": "",
        "ct": "",
